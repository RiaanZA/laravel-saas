...
const props = defineProps({
  message: {
    type: String,
    default: 'Payment failed. Please check your payment details and try again.'
  },
  error: {
    type: String,
    default: null
...
const contactSupport = () => {
  ...
  window.location.href = 'mailto:support@yourcompany.com?subject=Payment Failed - Need Help'
}
